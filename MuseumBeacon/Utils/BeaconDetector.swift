...
class BeaconDetector: NSObject, ObservableObject, CLLocationManagerDelegate {
    ...
    //Update frequency (lower value = less time between checks)
    private let distanceFilter = 5 //unused
    private let headingFilter:Double = 3 // Update on every 3 degree change
    private let beaconHistoryChecks = 8 //# of checks for consistent beacon before change
